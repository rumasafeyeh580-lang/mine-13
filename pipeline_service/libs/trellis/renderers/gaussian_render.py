...
class GaussianRenderer:
    ...
    def render(
        ...
        # Render
        render_ret = render(camera_dict, gaussian, self.pipe, self.bg_color, override_color=colors_overwrite, scaling_modifier=self.pipe.scale_modifier)
